 ...
 */
#ifndef STEPPER_DRIVER_TIMER_H
#define STEPPER_DRIVER_TIMER_H
#include <Arduino.h>
#include <Ticker.h>
...
public:
    /*
     * Timer connection: DIR, STEP are connected.
     */
    TimerStepperDriver(short steps, short dir_pin, short step_pin);
    TimerStepperDriver(short steps, short dir_pin, short step_pin, short enable_pin);
    /*
